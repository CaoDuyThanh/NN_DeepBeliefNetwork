...
def LoadData(datasetName):
    ...
    :param datasetName: the path to the dataset (here MNIST)
    '''
    ...
    if (not os.path.isfile(datasetName)) and data_file == 'mnist.pkl.gz':
        ...
        urllib.request.urlretrieve(origin, datasetName)

    print('... loading data')

    # Load the dataset
    with gzip.open(datasetName, 'rb') as f:
        try:
